...
if ($num_regs == 0)
{
	...
	$se_subio_imagen = subir_imagen($tipo,$archivo,$email);
 	...
 	// Si la foto en el formulario viene vacía, entonces le asigno el valor de la imagen genérica, si no, entonces el nombre de la foto que se subió
...
{
	$mensaje = "SeNo se pudo dar de alta al contacto con el email <b>$email</b> :(";
}

}
else
{
	$mensaje = "No se pudo dar de alta al contacto con el e-mail <b>$email</b> porque ya existe :/";
}
$conexion->close();
